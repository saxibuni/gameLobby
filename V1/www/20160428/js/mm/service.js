...
mm.config = {
    "service": {
        ...
        'SS18': "ws://lobbyss88.egame.staging.spadegaming.biz:8080",
        'SS28': "ws://lobbyss88.egame.staging.spadegaming.biz:8080",
        'SS48': "ws://game.ssplay.club:8080/websocket",
        'SS99': "ws://lobbyss88.egame.staging.spadegaming.biz:8080",
        // 'default': "ws://lobby.egame.staging.spadegaming.biz:8090"
        // 'default': "ws://lobby.egame.staging.spadegaming.biz:8080"
        'default': "ws://lobby.egame.staging.spadegaming.biz:8080"
    },
    "channel": "pc"
};
...
mm.Service = function(){
    ...
    var merchantCode = remote.getGlobal('sharedObject').merchantCode;
	
	mm.Service.it = this;

    var _connect = function(){
		_url = mm.config['service'][merchantCode] || mm.config['service']['default'];
